  ...
  while (queue.size() > 0) {
    ...
    if (!visited.has(id)) {
      ...
      neighboringNodes.forEach((neighborWeight, neighbor) => {
        ...
        if (
          currentWeight === void 0 ||
          (currentWeight > newWeight && (currentWeight / newWeight > 1.005 || (currentId !== void 0 && currentId < id)))
        ) {
...
function makeGetRowNeighbors({ photos, layoutOptions, targetRowHeight, limitNodeSearch, rowConstraints }) {
  return (node) => {
    ...
    const endOffset = Math.min(
      limitNodeSearch,
      (_b = rowConstraints == null ? void 0 : rowConstraints.maxPhotos) != null ? _b : Infinity,
    );
...
function calculateSizesValue(size, layout, layoutOptions) {
  var _a, _b;
  return calcWidth(
    (_b = (_a = size.match(/^\s*calc\((.*)\)\s*$/)) == null ? void 0 : _a[1]) != null ? _b : size,
    layout,
    layoutOptions,
  );
}
...
function RowContainerRenderer(props) {
  const { rowIndex, rowContainerProps: { style, className, ...restRowContainerProps } = {}, children } = props;
...
function RowsLayout(props) {
  ...
  const rowsLayout = React__namespace.useMemo(
    () => computeRowsLayout({ photos, layoutOptions }),
    [photos, layoutOptions],
  );
  const listRef = React__namespace.useRef(null);
  const virtualizer = reactVirtual.useWindowVirtualizer({
    count: (_a = rowsLayout == null ? void 0 : rowsLayout.length) != null ? _a : 0,
    estimateSize: (index) => {
      var _a2;
      return rowsLayout
        ? (((_a2 = rowsLayout[index][0]) == null ? void 0 : _a2.layout.height) || 0) + (layoutOptions.spacing || 0)
        : 0;
    },
    overscan: 5,
    scrollMargin:
      (_c = (_b = listRef == null ? void 0 : listRef.current) == null ? void 0 : _b.offsetTop) != null ? _c : 0,
  });
  React__namespace.useLayoutEffect(() => virtualizer.measure(), [rowsLayout, virtualizer]);
        ...
        return React__namespace.createElement(
          RowContainerRenderer,
          {
            ...
            rowContainerProps: {
              ...rowContainerProps,
              style: {
                ...(rowContainerProps == null ? void 0 : rowContainerProps.style),
                position: "absolute",
                top: 0,
                left: 0,
                width: "100%",
          ...
          rowsLayout[item.index].map(({ photo, layout }) =>
            React__namespace.createElement(PhotoRenderer, {
...
function ColumnContainerRenderer(props) {
  ...
  return React__namespace.createElement(
    React__namespace.Fragment,
    null,
    (renderColumnContainer != null ? renderColumnContainer : defaultRenderColumnContainer)({
      layoutOptions,
...
function ContainerRenderer(props) {
  ...
  return React__namespace.createElement(
    React__namespace.Fragment,
    null,
    (renderContainer != null ? renderContainer : defaultRenderContainer)({
      containerProps,
      containerRef,
      layout,
      children,
...
function containerWidthReducer(state, { newContainerWidth, newScrollbarWidth }) {
  ...
  if (
    ...
    newContainerWidth !== void 0 &&
    newScrollbarWidth !== void 0 &&
...
function renderLayout(props, componentsProps, layoutOptions) {
  ...
  if (layout === "rows") {
    return React__namespace.createElement(RowsLayout, {
      layoutOptions,
      renderRowContainer,
      ...commonLayoutProps,
    });
  ...
  if (layout === "columns") {
    return React__namespace.createElement(ColumnsLayout, {
      layoutOptions,
      renderColumnContainer,
      ...commonLayoutProps,
    });
  }
  return React__namespace.createElement(MasonryLayout, {
    layoutOptions,
    renderColumnContainer,
    ...commonLayoutProps,
  });
