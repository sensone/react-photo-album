...
function RowContainerRenderer(props) {
  ...
  return React.createElement("div", { ...rowContainerProps, "data-index": rowIndex, key: rowIndex }, children);
}
function RowsLayout(props) {
  ...
  const virtualizer = useWindowVirtualizer({
    ...
    estimateSize: (index) => {
      var _a2;
      return rowsLayout ? (((_a2 = rowsLayout[index][0]) == null ? void 0 : _a2.layout.height) || 0) + (layoutOptions.spacing || 0) : 0;
    },
    overscan: 5,
    scrollMargin: (_c = (_b = listRef == null ? void 0 : listRef.current) == null ? void 0 : _b.offsetTop) != null ? _c : 0
  });
  React.useLayoutEffect(() => virtualizer.measure(), [rowsLayout, virtualizer]);
  if (!rowsLayout)
    return null;
  return React.createElement("div", { ref: listRef }, React.createElement(
    "div",
    {
      style: {
    ...
    virtualizer.getVirtualItems().map((item) => {
      return React.createElement(
        ...
        rowsLayout[item.index].map(({ photo, layout }) => React.createElement(
          PhotoRenderer,
          {
